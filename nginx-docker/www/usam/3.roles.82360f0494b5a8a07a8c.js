webpackJsonp([3],Array(526).concat([
/* 526 */
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RaisedButton = __webpack_require__(702);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Snackbar = __webpack_require__(704);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _SnackbarBody = __webpack_require__(705);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _withWidth = __webpack_require__(706);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _role = __webpack_require__(905);
	
	var _RolesTable = __webpack_require__(906);
	
	var _RolesTable2 = _interopRequireDefault(_RolesTable);
	
	var _CreateRoleContainer = __webpack_require__(910);
	
	var _CreateRoleContainer2 = _interopRequireDefault(_CreateRoleContainer);
	
	__webpack_require__(914);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var mapDispatchToProps = (0, _extends3.default)({}, _roles.actions, _role.actions);
	
	var mapStateToProps = function mapStateToProps(state) {
	  return (0, _extends3.default)({}, state.roles);
	};
	
	var RolesContainer = function (_Component) {
	  (0, _inherits3.default)(RolesContainer, _Component);
	  ...
	  function RolesContainer() {
	    ...
	    (0, _classCallCheck3.default)(this, RolesContainer);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = RolesContainer.__proto__ || (0, _getPrototypeOf2.default)(RolesContainer)).call.apply(_ref, [this].concat(args))), _this), _this.onDeleteRole = function (ev) {
	      _this.props.deleteRoles(_this.props.selectedRoleIds);
	    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
	  }
	
	  (0, _createClass3.default)(RolesContainer, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      if (!this.props.isRequesting && !this.props.hasReceived) {
	        this.props.getRoles();
	      }
	    }
	  }, {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(_CreateRoleContainer2.default, null)
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	          _react2.default.createElement(_RolesTable2.default, this.props)
	        )
	      );
	    }
	  }]);
	...
	RolesContainer.propTypes = {
	  ...
	  isRequesting: _propTypes2.default.bool.isRequired,
	  hasReceived: _propTypes2.default.bool.isRequired,
	  errors: _propTypes2.default.any.isRequired
	};
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(RolesContainer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _moment = __webpack_require__(710);
	
	var _moment2 = _interopRequireDefault(_moment);
	
	var _ms = __webpack_require__(827);
	...
	var createRole = function createRole() {
	  ...
	  return function (dispatch, getState) {
	    var role = getState().role;
	
	    dispatch({
	      type: _roles2.default.CREATING_ROLE,
	      role: role
	    });
	
	    return _ApiClient2.default.post('/Roles', { data: role }).then(function (r) {
	      // get it, since the api doesn't return the relational data in the post response
	      return _ApiClient2.default.get('/Roles/' + r.id);
	    }).then(function (r) {
	      dispatch({
	        type: _roles2.default.CREATED_ROLE,
	        role: r
	      });
	
	      // reset state after 4s
	      setTimeout(function () {
	        dispatch({
	          type: _roles2.default.CHANGE_DRAFT_ROLE,
	          changes: {}
	        });
	      }, 4000);
	    }).catch(function (err) {
	      ...
	      dispatch({
	        type: _roles2.default.CREATED_ROLE_ERROR,
	        err: err
	      });
	    });
	  };
	 ...
	 */
	var changeDraft = function changeDraft(changes) {
	  return function (dispatch, getState) {
	    dispatch({
	      type: _roles2.default.CHANGE_DRAFT_ROLE,
	      changes: changes
	...
	function reducer() {
	  ...
	  var newState = state;
	  switch (action.type) {
	    case _roles2.default.CHANGE_DRAFT_ROLE:
	      newState = (0, _assign2.default)({}, state, action.changes, {
	        isSaved: false,
	        isSaving: false,
	        errors: false
	      });
	      delete newState.id;
	      return newState;
	    case _roles2.default.CREATING_ROLE:
	    ...
	    case _roles2.default.CREATED_ROLE:
	      ...
	      newState = (0, _assign2.default)({}, DEFAULT_STATE, {
	        isSaved: true,
	        isSaving: false
	      });
	      return newState;
	    case _roles2.default.CREATED_ROLE_ERROR:
	      newState = (0, _assign2.default)({}, state, {
	        isSaving: true,
	        errors: action.err
	      });
	      return newState; // TODO - validation errors!
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RoleRow = __webpack_require__(907);
	...
	var RolesTableView = function (_Component) {
	  (0, _inherits3.default)(RolesTableView, _Component);
	  ...
	  function RolesTableView() {
	    ...
	    (0, _classCallCheck3.default)(this, RolesTableView);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = RolesTableView.__proto__ || (0, _getPrototypeOf2.default)(RolesTableView)).call.apply(_ref, [this].concat(args))), _this), _this.isSelected = function (id) {
	      var selected = _this.props.selectedRoleIds.indexOf(id) !== -1;
	      return selected;
	    }, _this.onItemSelect = function (id) {
	      return function (evt, selected) {
	        var selectedIds = [].concat(_this.props.selectedRoleIds);
	        if (selected) {
	          selectedIds.push(id);
	        } else {
	  ...
	  (0, _createClass3.default)(RolesTableView, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      var rows = props.roles.map(function (role, i) {
	        var id = role.id;
	
	        var selected = _this2.isSelected(id);
	        return _react2.default.createElement(_RoleRow2.default, (0, _extends3.default)({ key: 'role-table-row-' + id }, role, { selected: selected, onSelect: onItemSelect(id) }));
	      });
	...
	RolesTableView.defaultProps = {
	  roles: [],
	  errors: false,
	  selectedRoleIds: []
	};
	
	RolesTableView.propTypes = {
	  roles: _propTypes2.default.array.isRequired,
	  hasReceived: _propTypes2.default.bool,
	  isRequesting: _propTypes2.default.bool,
	  errors: _propTypes2.default.any.isRequired,
	  selectedRoleIds: _propTypes2.default.array.isRequired,
	  selectRoles: _propTypes2.default.func.isRequired
	};
	
	exports.default = RolesTableView;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RoleRow = function RoleRow(props) {
	  var name = props.name,
	      id = props.id,
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'td',
	      null,
	      _react2.default.createElement(_Checkbox2.default, { checked: props.selected, onCheck: props.onSelect })
	    ),
	    _react2.default.createElement(
	      'td',
	      null,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".roles-list{border-spacing:0;border-collapse:collapse}.roles-list td,.roles-list th{padding:.4rem .3rem .2rem .1rem}.roles-list tbody tr:nth-child(2n) td{background-color:rgba(0,0,0,.05);border-bottom:1px solid rgba(0,0,0,.1)}.roles-list thead tr th{text-align:left}", "", {"version":3,"sources":["/Users/kruegerm/dev/projects/outage-prediction/user-admin-ui/src/routes/Roles/components/src/routes/Roles/components/RolesTable.scss"],"names":[],"mappings":"AAAA,YAEE,iBAAiB,wBACQ,CAH3B,8BAOG,+BAAgC,CAPnC,sCAaQ,iCAAqC,sCACM,CAdnD,wBAuBQ,eAAgB,CAGjB","file":"RolesTable.scss","sourcesContent":[".roles-list {\n\n  border-spacing: 0;\n  border-collapse: collapse;\n\n  th,\n  td {\n   padding: .4rem .3rem .2rem .1rem;\n  }\n\n  tbody {\n    tr:nth-child(even) {\n      td {\n        background-color: rgba(0, 0, 0, 0.05);\n        border-bottom: 1px solid rgba(0, 0, 0, 0.1);\n      }\n    }\n  }\n\n  thead {\n    tr {\n\n      th {\n        text-align: left;\n\n\n      }\n    }\n  }\n}"],"sourceRoot":""}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _keys = __webpack_require__(449);
	
	var _keys2 = _interopRequireDefault(_keys);
	
	var _defineProperty2 = __webpack_require__(699);
	...
	var _CreateRole = __webpack_require__(911);
	...
	var mapDispatchToProps = _role.actions;
	
	var changeHandlerMappings = {
	  onChangeDescription: 'description',
	  onChangeName: 'name'
	};
	
	var CreateRoleContainer = function (_Component) {
	  (0, _inherits3.default)(CreateRoleContainer, _Component);
	  ...
	  function CreateRoleContainer() {
	    ...
	    (0, _classCallCheck3.default)(this, CreateRoleContainer);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = CreateRoleContainer.__proto__ || (0, _getPrototypeOf2.default)(CreateRoleContainer)).call.apply(_ref, [this].concat(args))), _this), _this.handler = function (propName, ev, i, newVal) {
	      if (i && !newVal) {
	        newVal = i;
	      }
	
	      _this.props.changeDraft((0, _defineProperty3.default)({}, propName, newVal));
	    }, _this.createRole = function (ev) {
	      _this.props.createRole();
	    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
	  }
	
	  (0, _createClass3.default)(CreateRoleContainer, [{
	    key: 'render',
	    value: function render() {
	      var _this2 = this;
	      ...
	      var passedHandlers = {};
	      (0, _keys2.default)(changeHandlerMappings).forEach(function (key) {
	        passedHandlers[key] = _this2.handler.bind(_this2, changeHandlerMappings[key]);
	      });
	      passedHandlers.onCreate = this.createRole;
	
	      return _react2.default.createElement(_CreateRole2.default, (0, _extends3.default)({}, passedHandlers, this.props));
	    }
	  }]);
	...
	CreateRoleContainer.defaultProps = {
	  name: "",
	  description: ""
	};
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(CreateRoleContainer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _RaisedButton = __webpack_require__(701);
	
	var _RaisedButton2 = _interopRequireDefault(_RaisedButton);
	
	var _Divider = __webpack_require__(497);
	...
	var _Snackbar = __webpack_require__(703);
	...
	var CreateRoleView = function CreateRoleView(props) {
	  var openSnackbar = !!(props.isSaved && props.id);
	  var snackbarMessage = openSnackbar ? props.hasSaved + ' has been saved' : '';
	  var buttonLabel = props.isSaving ? 'Saving...' : 'Save';
	  var className = props.isSaving ? 'create-role-view state-saving' : 'create-role-view';
	
	  return _react2.default.createElement(
	    _Paper2.default,
	    { className: className, style: paperStyle },
	    _react2.default.createElement(
	      'h2',
	      null,
	      'Create Role'
	    ...
	    _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_TextField2.default, { floatingLabelText: 'Role Name',
	    ...
	    _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_TextField2.default, { floatingLabelText: 'Description [optional]',
	        disabled: props.isSaving,
	        multiLine: true,
	        rows: 5,
	    ...
	    _react2.default.createElement(
	      'div',
	      null,
	      _react2.default.createElement(_RaisedButton2.default, { label: 'Save', onTouchTap: props.onCreate })
	    ),
	    _react2.default.createElement(_Snackbar2.default, { bodyStyle: { height: 100, lineHeight: '32px', flexGrow: 0 },
	      open: openSnackbar,
	      message: snackbarMessage,
	      autoHideDuration: 4000 })
	  );
	};
	exports.default = CreateRoleView;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"CreateRole.scss","sourceRoot":""}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".roles-layout>div:first-child{float:left;padding:0 3rem}", "", {"version":3,"sources":["/Users/kruegerm/dev/projects/outage-prediction/user-admin-ui/src/routes/Roles/components/src/routes/Roles/components/RolesLayout.scss"],"names":[],"mappings":"AAAA,8BAMI,WAAW,cAII,CAChB","file":"RolesLayout.scss","sourcesContent":[".roles-layout {\n  //$widthSideCol: 180px;\n  //position: relative;\n  //padding-left: $widthSideCol;\n\n  > div:first-child {\n    float: left;\n    //position: absolute;\n    //left: 0;\n    //width: $widthSideCol;\n    padding: 0 3rem;\n  }\n\n  > div:first-child + div {\n\n  }\n}"],"sourceRoot":""}]);
...
//# sourceMappingURL=3.roles.82360f0494b5a8a07a8c.js.map