...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Toolbar2 = __webpack_require__(898);
	
	var _Toolbar3 = _interopRequireDefault(_Toolbar2);
	
	var _ToolbarGroup2 = __webpack_require__(899);
	
	var _ToolbarGroup3 = _interopRequireDefault(_ToolbarGroup2);
	
	var _ToolbarSeparator2 = __webpack_require__(900);
	
	var _ToolbarSeparator3 = _interopRequireDefault(_ToolbarSeparator2);
	
	var _ToolbarTitle2 = __webpack_require__(901);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	ToolbarSeparator.contextTypes = {
	 ...
	 true ? ToolbarSeparator.propTypes = {
	  /**
	   * The css class name of the root element.
	   */
	  className: _propTypes2.default.string,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _OrganizationContainer = __webpack_require__(918);
	
	var _OrganizationContainer2 = _interopRequireDefault(_OrganizationContainer);
	
	var _ListView = __webpack_require__(923);
	
	var _ListView2 = _interopRequireDefault(_ListView);
	
	var _ListControls = __webpack_require__(929);
	...
	var mapDispatchToProps = (0, _extends3.default)({}, _organizations.actions);
	
	var mapStateToProps = function mapStateToProps(state) {
	  return (0, _extends3.default)({}, state.organizations);
	};
	...
	var Container = function (_Component) {
	  ...
	  function Container(props) {
	    ...
	    _this.onEnter = function (id) {
	      var organization = (0, _findById2.default)(id, _this.props.items);
	      _this.setState({
	  ...
	  (0, _createClass3.default)(Container, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var editCreate = this.state.isEditing && _react2.default.createElement(_OrganizationContainer2.default, (0, _extends3.default)({ isEditing: this.state.isEditing, onExit: this.onExit }, this.state.organization));
	      return _react2.default.createElement(
	        'div',
	        { style: {
	            'width': '380px',
	        ...
	        _react2.default.createElement(_ListControls2.default, (0, _extends3.default)({}, this.props, { onCreate: this.onEnter })),
	        _react2.default.createElement(_ListView2.default, (0, _extends3.default)({}, this.props, { onItemEdit: this.onEnter })),
	        editCreate
	      );
	    }
	  }]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _OrganizationView = __webpack_require__(919);
	
	var _OrganizationView2 = _interopRequireDefault(_OrganizationView);
	...
	var mapDispatchToProps = {
	  saveItem: _organizations.actions.saveItem
	};
	
	var OrganizationContainer = function (_Component) {
	  (0, _inherits3.default)(OrganizationContainer, _Component);
	  (0, _createClass3.default)(OrganizationContainer, [{
	    key: 'getStateFromProps',
	    value: function getStateFromProps(props) {
	      var settingsInvalid = null;
	      return {
	        id: props.id,
	        name: props.name,
	        settings: (0, _extends3.default)({}, props.settings),
	        settingsInvalid: settingsInvalid
	      };
	    }
	  }]);
	
	  function OrganizationContainer(props) {
	    (0, _classCallCheck3.default)(this, OrganizationContainer);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (OrganizationContainer.__proto__ || (0, _getPrototypeOf2.default)(OrganizationContainer)).call(this, props));
	
	    _this.onSave = function () {
	      _this.props.saveItem((0, _extends3.default)({}, _this.state));
	    };
	    ...
	    _this.onChange = function (propName, newVal) {
	      var state = {};
	      if (propName === 'settings') {
	        try {
	          newVal = JSON.parse(newVal);
	          state.settingsInvalid = null;
	        } catch (err) {
	          state.settingsInvalid = true;
	        }
	      }
	  ...
	  (0, _createClass3.default)(OrganizationContainer, [{
	    ...
	    value: function render() {
	      var orgViewProps = {
	        ...
	        settingsInvalid: this.state.settingsInvalid,
	      ...
	      return _react2.default.createElement(_OrganizationView2.default, orgViewProps);
	    }
	  }]);
	...
	OrganizationContainer.propTypes = {
	  ...
	  id: _propTypes2.default.string, // null if creating new, not null for edit
	  name: _propTypes2.default.string.isRequired,
	  settings: _propTypes2.default.object.isRequired,
	  onExit: _propTypes2.default.func.isRequired,
	  saveItem: _propTypes2.default.func.isRequired,
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(OrganizationContainer);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _EditView = __webpack_require__(920);
	
	var _EditView2 = _interopRequireDefault(_EditView);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var OrganizationView = function OrganizationView(props) {
	  var editViewProps = {
	    name: props.name,
	    settings: props.settings,
	    settingsInvalid: props.settingsInvalid,
	    id: props.id,
	    changeHandler: props.onChange
	  };
	
	  var disabledSave = props.settingsInvalid || props.isSaving;
	  var label = props.isSaving ? 'Saving...' : 'Save';
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_EditView2.default, editViewProps)
	  );
	};
	...
	OrganizationView.propTypes = {
	  ...
	  name: _propTypes2.default.string.isRequired,
	  settings: _propTypes2.default.object.isRequired,
	  settingsInvalid: _propTypes2.default.bool,
	...
	exports.default = OrganizationView;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var EditView = function EditView(props) {
	    ...
	    var snackbarMessage = openSnackbar ? props.name + ' has been created' : '';
	    var className = 'organization-edit-view ' + (props.isSaving ? 'state-saving' : '');
	    var idDisplay = !!props.id && _react2.default.createElement(
	        'span',
	        { className: 'id-display' },
	        'id: ',
	        props.id
	    );
	    var errors = props.errors && props.errors.length > 0 && _react2.default.createElement(
	        'div',
	        { className: 'errors' },
	        'An error occured when trying save this Organization.',
	        _react2.default.createElement(
	            'ul',
	            null,
	    ...
	    var invalidSettingsErrorText = props.settingsInvalid ? 'Invalid JSON' : false;
	    var settings = typeof props.settings === 'string' ? props.settings : (0, _stringify2.default)(props.settings);
	    ...
	    return _react2.default.createElement(
	        ...
	        errors,
	        idDisplay,
	        _react2.default.createElement(_TextField2.default, { floatingLabelText: 'Name', disabled: props.isSaving, onChange: function onChange(evt, val) {
	                return props.changeHandler('name', val);
	            }, value: props.name }),
	        _react2.default.createElement('br', null),
	        _react2.default.createElement(_TextField2.default, { errorText: invalidSettingsErrorText,
	            floatingLabelText: 'Settings',
	            disabled: props.isSaving,
	            multiLine: true,
	            rows: 3,
	            onChange: function onChange(evt, val) {
	                return props.changeHandler('settings', val);
	            },
	            value: settings }),
	        _react2.default.createElement('br', null),
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".organization-edit-view{width:480px;margin:0 auto;height:420px}.organization-edit-view.state-saving .send-button{background-color:#000}.organization-edit-view .errors{background-color:rgba(255,0,0,.2);border-radius:.14rem;box-shadow:.1rem .1rem 1rem 0 rgba(0,0,0,.1);padding:.4rem}.organization-edit-view .id-display{font-size:.5rem;display:block}", "", {"version":3,"sources":["/Users/kruegerm/dev/projects/outage-prediction/user-admin-ui/src/routes/Organizations/components/src/routes/Organizations/components/EditView.scss"],"names":[],"mappings":"AACA,wBACE,YAAY,cACE,YACD,CAHf,kDAOM,qBAAuB,CAP7B,gCAYI,kCAAsC,qBACjB,6CACyB,aAChC,CAflB,oCAmBI,gBAAgB,aACF,CACf","file":"EditView.scss","sourcesContent":["\n.organization-edit-view {\n  width: 480px;\n  margin: 0 auto;\n  height: 420px;\n\n  &.state-saving {\n    .send-button {\n      background-color: black;\n    }\n  }\n\n  .errors {\n    background-color: rgba(255, 0, 0, .20);\n    border-radius: .14rem;\n    box-shadow: .1rem .1rem 1rem 0 rgba(0,0,0, .1);\n    padding: .4rem;\n  }\n\n  .id-display {\n    font-size: .5rem;\n    display: block;\n  }\n\n}\n\n"],"sourceRoot":""}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ItemView = __webpack_require__(926);
	...
	var ListView = function (_Component) {
	  ...
	  (0, _createClass3.default)(ListView, [{
	    ...
	    value: function render() {
	      ...
	      var rows = props.items.map(function (item, i) {
	        var id = item.id;
	
	        return _react2.default.createElement(_ItemView2.default, (0, _extends3.default)({ key: TYPE_NAME + '-item-' + id }, item, { onEdit: function onEdit() {
	            return _this2.onItemEdit(id);
	          } }));
	      });
	
	      return _react2.default.createElement(
	        'div',
	        { className: TYPE_NAME + '-list-view' },
	        _react2.default.createElement(
	          _List.List,
	          null,
	          rows
	...
	ListView.defaultProps = {
	  items: [],
	  errors: false,
	  onItemEdit: function onItemEdit(id) {
	    console.log('editing org: ', id);
	  }
	};
	...
	ListView.propTypes = {
	  ...
	  errors: _propTypes2.default.any.isRequired,
	  onItemEdit: _propTypes2.default.func.isRequired
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(true) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept(925, function() {
				var newContent = __webpack_require__(925);
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"ListView.scss","sourceRoot":""}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RowItem = function RowItem(props) {
	  ...
	  var button = _react2.default.createElement(_FlatButton2.default, {
	    label: 'Edit',
	    primary: true,
	    style: { top: '5px' },
	  ...
	  return _react2.default.createElement(_List.ListItem, { primaryText: props.name, rightIconButton: button });
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"ItemView.scss","sourceRoot":""}]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Toolbar = __webpack_require__(897);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var ListControls = function (_Component) {
	  (0, _inherits3.default)(ListControls, _Component);
	  ...
	  function ListControls() {
	    ...
	    (0, _classCallCheck3.default)(this, ListControls);
	
	    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
	      args[_key] = arguments[_key];
	    }
	
	    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = ListControls.__proto__ || (0, _getPrototypeOf2.default)(ListControls)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function (evt) {
	      _this.props.onCreate();
	    }, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
	  }
	
	  (0, _createClass3.default)(ListControls, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_RaisedButton2.default, { label: 'Create', primary: true, onTouchTap: this.onCreate });
	    }
	  }]);
	  return ListControls;
	}(_react.Component);
...
//# sourceMappingURL=4.organizations.82360f0494b5a8a07a8c.js.map